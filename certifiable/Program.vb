...
Module Program
    ...
    Private Function CreateOpeningComments(ByRef cert As X509Certificate2, ByVal startCommentString As String) As String
        ...
        returnValue &= startCommentString & vbCrLf
        returnValue &= startCommentString & "It is valid between " & cert.NotBefore.ToString & " (UTC) and " & cert.NotAfter.ToString & " (UTC) inclusive." & vbCrLf
        returnValue &= startCommentString & vbCrLf
    ...
    Private Function CreateOutputFileForCPlusPlusProgMem(cert As X509Certificate2) As String
        ...
        Try
            ...
            outputString = CreateOpeningComments(cert, startCommentString)
    ...
    Private Sub Generate(cert As X509Certificate2)
        ...
        Select Case iGenerateLanguage
            ...
            Case "c++"
                codeType = "C++"
                If iUsePROGMEM Then
                    outputString = CreateOutputFileForCPlusPlusProgMem(cert)
                Else
    ...
    Private Sub DisplayHelp()
        ...
        Console_WriteLineInColour("       if c++ is followed by progmem the generated code will store the certificate in program memory (flash memory) rather than in RAM (SRAM)")
